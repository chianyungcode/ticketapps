...
const Footer = () => {
  ...
  return (
    <footer className="mx-auto max-w-4xl py-5 text-gray-500 xl:max-w-6xl ">
      <div className="justify-between gap-6 md:flex">
        <div className="flex-1">
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <label className="block pb-2 pt-4">Stay up to date</label>
            <div className="flex max-w-sm items-center rounded-xl border p-1">
              <input
                type="email"
